...
//            <button id="login-btn" style={{display: "flex", alignItems: "center"}}><span style={{marginRight: "auto"}}>
//              Have an account?</span>
//           <Link to="/profile/login"> Log in</Link>
//           </button>
         
//           <button><Link to="/profile/register">Sign up</Link></button>
//            <p><span class="quote">Find someone<br></br> who loves you like<br></br> Kanye loves Kanye</span>
//          </p>
//        </div> 
//       </section>
//        </>
